...
data:
  ...
  sync-config.yaml: |
    kibana:
      url: "https://kibana.local.example.com"
      space: "default"
      auth:
        type: "basic"
        username: "elastic"
    ...
    spec:
      containers:
        ...
        - name: elastic-synthetic-monitor
          ...
          env:
            - name: FLEET_SERVER_ENABLE
              value: "false"
            - name: FLEET_URL
              value: "https://elastic-fleet.local.example.com:443"
        ...
        - name: kibana-sync
          ...
          env:
            - name: KIBANA_URL
              value: "https://kibana.local.example.com"
            - name: SYNC_INTERVAL
              value: "30"
            - name: PROJECT_ID
...
data:
  sync-monitors.py: |
    ...
    class KibanaSyncManager:
        def __init__(self):
            self.kibana_url = os.getenv('KIBANA_URL', 'https://kibana.local.example.com')
...
- Results sent to Elasticsearch via Fleet Server (`https://elastic-fleet.local.example.com:443`)
...
curl -X GET "https://kibana.local.example.com/api/synthetics/monitors"
```
