...
TRIVY_DB_REPOSITORY="${TRIVY_DB_REPOSITORY:-registry.local.example.com/ghcrio/aquasecurity/trivy-db:2}"
TRIVY_JAVA_DB_REPOSITORY="${TRIVY_JAVA_DB_REPOSITORY:-registry.local.example.com/ghcrio/aquasecurity/trivy-java-db:1}"
...
Optional environment variables:
  TRIVY_DB_REPOSITORY=<oci-ref>    Trivy DB OCI reference (default: example proxy)
  TRIVY_JAVA_DB_REPOSITORY=<ref>   Trivy Java DB OCI reference (default: example proxy)
